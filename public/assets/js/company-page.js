...
var _aboutToggle = _interopRequireDefault(require("../pages/company/about-toggle"));

var _slider = _interopRequireDefault(require("../pages/company/slider"));

var _toggleContent = _interopRequireDefault(require("../components/toggleContent"));
...
/*---=== declare variables ===---*/
var companyAbout = (0, _querySelector.qS)('.js-company-about');
var truncatedText = '.js-truncated-text';
var galleryArr = (0, _querySelector.qSA)('.js-gallery');
var galleryOpenArr = (0, _querySelector.qSA)('.js-open-gallery');
var arrCompanyInfo = (0, _querySelector.qSA)('.js-company-info');
/*---=== /declare variables ===---*/
...
document.addEventListener("DOMContentLoaded", function () {
  if (arrCompanyInfo.length > 0) {
    (0, _toggleContent.default)(arrCompanyInfo, '.js-company-info-content', '.js-company-info-header');
  }

  if (companyAbout != null) {
    (0, _aboutToggle.default)(truncatedText);
  }

  if (galleryArr.length > 0) {
    (0, _slider.default)(galleryOpenArr);
  }
});
/*---=== /run modules ===---*/

},{"../components/toggleContent":2,"../functions/querySelector":4,"../pages/company/about-toggle":6,"../pages/company/slider":7}],2:[function(require,module,exports){
"use strict";
...
var _slide = require("../functions/slide");

var _default = function _default(arrContent, classNameBody, classNameHead) {
  arrContent.map(function (elem) {
    var arrContentTouch = classNameHead ? elem.querySelector("".concat(classNameHead)) : elem;
    arrContentTouch.addEventListener('click', function () {
      (0, _slide.slideToggle)(elem.classList.toggle('is-open'), elem.querySelector("".concat(classNameBody)));
    });
  });
};
...
},{"../functions/slide":5}],3:[function(require,module,exports){
"use strict";
...
var _default = function _default(element, selector) {
  var includeElement = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
function slideUp(target) {
  ...
  target.style.setProperty('transition-duration', "".concat(duration, "ms"));
  target.style.setProperty('box-sizing', 'border-box');
  target.style.setProperty('height', "".concat(target.offsetHeight, "px"));
...
function slideDown(target) {
  ...
  target.style.setProperty('transition-property', 'height, margin, padding');
  target.style.setProperty('transition-duration', "".concat(duration, "ms"));
  target.style.setProperty('height', "".concat(height, "px"));
  target.style.removeProperty('padding-top');
  target.style.removeProperty('padding-bottom');
  target.style.removeProperty('margin-top');
  target.style.removeProperty('margin-bottom');
...
function slideToggle(boolean, target) {
  var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 500;
  var blockType = arguments.length > 3 ? arguments[3] : undefined;
...
var _Cuttr = _interopRequireDefault(require("Cuttr"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _default = function _default(truncatedText) {
  new _Cuttr.default(truncatedText, {
    truncate: 'characters',
    length: 273,
    readMore: true,
...
},{"Cuttr":8}],7:[function(require,module,exports){
"use strict";
...
var _getParents3 = _interopRequireDefault(require("../../functions/getParents"));
...
var _default = function _default(galleryOpenArr) {
  var gallery = (0, _glightbox.default)({
    keyboardNavigation: true,
    touchNavigation: true,
    loop: true
  });
  galleryOpenArr.forEach(function (element) {
    element.addEventListener('click', function (event) {
      var _getParents = (0, _getParents3.default)(event.target, '.company-info__content', true),
          _getParents2 = _slicedToArray(_getParents, 1),
          parents = _getParents2[0];
...
},{"../../functions/getParents":3,"glightbox":9}],8:[function(require,module,exports){
/*!
 * Cuttr 1.2.0
